...
def extract_and_stage_artifact(artifact, tar_file, bitness_type, top_level_dll_directory):
    server_folder = prepare_directory(top_level_dll_directory, sub_directory="gRPC LabVIEW/Libraries")
    generator_folder = prepare_directory(top_level_dll_directory, sub_directory="gRPC LabVIEW Generator/Libraries")
